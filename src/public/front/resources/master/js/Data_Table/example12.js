...
{id:36, name:"Unity Butler", position:"Marketing Designer", office:"San Francisco", extension:"5384", startDate:"2009/12/09", salary:"Unity Butler"},
  ...
  },
 {
    ...
    render: function (data, type, row, meta) {
      return '<a class="delbutton btn btn-danger fw-bold p-1" href="#"> حذف </a>';
    },
    disabled: true
  } 
  ];
  ...
  // Edit
  $(document).on('click', "[id^='example_one'] tbody ", 'tr', function () {
  ...
  // Delete
  $(document).on('click', "[id^='example_one'] .delbutton", 'tr', function (x) {
    var tableID = $(this).closest('table').attr('id');    // id of the table
    var that = $( '#'+tableID )[0].altEditor;
  ...
  $('#addbutton').on('click', function () {
    var that = $( '#example_one' )[0].altEditor;
    that._openAddModal();
