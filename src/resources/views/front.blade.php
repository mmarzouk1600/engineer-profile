...
@endif
    <head>
        ...
        <link href="https://fonts.googleapis.com/css2?family=Almarai:wght@300;400;700;800&family=Kumbh+Sans:wght@100;200;300;400;500;600;700;800;900&display=swap" rel="stylesheet">
        <!-- app CSS -->
        <link rel="stylesheet" type="text/css" href="{{asset('front/resources/master/vendor/font-awesome/css/all.min.css')}}" />
